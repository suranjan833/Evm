...
class NewsViewScreenElonMusk extends StatefulWidget {
  const NewsViewScreenElonMusk({Key key}) : super(key: key);

  @override
  State<NewsViewScreenElonMusk> createState() => _NewsViewScreenElonMuskState();
}

class _NewsViewScreenElonMuskState extends State<NewsViewScreenElonMusk> {
  List<int> likedIndex = [];
  bool _loading = false;
  ...
  refreshPosts() async {
    ...
    if (_controller.offset >= _controller.position.maxScrollExtent &&
      ...
      await db
          .fatchLatestNewsElonMuskLoadMore()
